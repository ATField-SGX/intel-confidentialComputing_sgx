...
#  This script is used to copy files from src to dest as described in a BOM file
#  example: python3 gen_source.py --bom=PATH_TO_BOM [--cleanup=false] [--deliverydir=DIR_RELATIVE_TO_gen_source.py] [--installdir=DIR_APPEND_BEFORE_INSTALLDIR]
#
...
if __name__ == "__main__":
	...
	if ret == False:
		print ("Usage:")
		print ("python3 gen_source.py --bom=PATH_TO_BOM [--cleanup=false] [--deliverydir=DIR_RELATIVE_TO_gen_source.py] [--installdir=DIR_APPEND_BEFORE_INSTALLDIR]")
		exit(1)
