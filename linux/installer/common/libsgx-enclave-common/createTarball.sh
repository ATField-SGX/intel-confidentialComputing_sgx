...
python3 ${SCRIPT_DIR}/gen_source.py --bom=BOMs/libsgx-enclave-common.txt --deliverydir=${ROOT_DIR} --installdir=pkgroot/libsgx-enclave-common
python3 ${SCRIPT_DIR}/gen_source.py --bom=BOMs/libsgx-enclave-common-dev.txt --deliverydir=${ROOT_DIR} --cleanup=false --installdir=pkgroot/libsgx-enclave-common-dev
python3 ${SCRIPT_DIR}/gen_source.py --bom=BOMs/libsgx-enclave-common-package.txt --deliverydir=${ROOT_DIR} --cleanup=false
