...
- Key changes:
  ...
  2. [BREAKING] Removed code supporting the deprecated Launch Enclave, whitelist management and supporting "out-of-tree" driver.
  ...
  3. [BREAKING] The corresponding libraries (libsgx_epid.so, libsgx_launch.so, ...) are removed, including their _SIM counterparts in the SGX SDK.
