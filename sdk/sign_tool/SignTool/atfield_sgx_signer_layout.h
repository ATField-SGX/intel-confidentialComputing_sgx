...
typedef struct atfield_sgx_signer_layout_result_v2 {
...
} atfield_sgx_signer_layout_result_v2;

#define ATFIELD_SGX_SIGNER_LAYOUT_ABI_V2 2u
...
int atfield_sgx_build_signer_layout_v2(
