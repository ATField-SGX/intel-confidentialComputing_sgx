...
IPPAPI(IppStatus, k1_ippsHashGetSizeOptimal_rmf,(int* pSize, const IppsHashMethod* pMethod))
IPPAPI(IppStatus, l9_ippsHashGetSizeOptimal_rmf,(int* pSize, const IppsHashMethod* pMethod))
IPPAPI(IppStatus, y8_ippsHashGetSizeOptimal_rmf,(int* pSize, const IppsHashMethod* pMethod))

IPPFUN(IppStatus, sgx_disp_ippsHashGetSizeOptimal_rmf,(int* pSize, const IppsHashMethod* pMethod))
{
    Ipp64u _features = ippcpGetEnabledCpuFeatures();

    if (AVX3I_FEATURES == (_features & AVX3I_FEATURES))
    {
        return k1_ippsHashGetSizeOptimal_rmf(pSize, pMethod);
    }
    if (ippCPUID_AVX2 == (_features & ippCPUID_AVX2))
    {
        return l9_ippsHashGetSizeOptimal_rmf(pSize, pMethod);
    }
    if (ippCPUID_SSE42 == (_features & ippCPUID_SSE42))
    {
        return y8_ippsHashGetSizeOptimal_rmf(pSize, pMethod);
    }
